SubProceso mostrarResultado ( f,c, arreglo, i, j )
	Definir resultado Como Entero;
	Para f<-0 Hasta 9 Con Paso 1 Hacer
		Para c<-0 Hasta 9 Con Paso 1 Hacer
			
			Si arreglo[f,c] == arreglo[i,j] Entonces
	...
	Escribir "El resultado de la multiplicación indicada es : ",resultado;
...
Proceso tablasMultiplicar
	...
	Escribir "Ingresa el número de la fila que deseas conocer";
	Leer filaNumero;
	
	Escribir "Ingresa el número de la columna que deseas conocer";
	Leer columnaNumero;
	
	
    mostrarResultado( fila,columna, matriz, filaNumero, columnaNumero );
